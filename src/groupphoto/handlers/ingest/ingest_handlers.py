"""Handlers for groupphoto.Ingest — list images, convert RAW → full-res 16-bit TIFF."""
...
def handle_convert_tree(params: dict[str, Any]) -> dict[str, Any]:
    ...
    if params.get("recursive", True):
        ...
        in_exts = cp.parse_from(params.get("from_sel") or "any", default=None) \
